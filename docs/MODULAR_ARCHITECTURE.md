...
1. Read [REFACTORING_SUMMARY.md](REFACTORING_SUMMARY.md) - Overview of changes
2. Run `python3 demo_architecture.py` - See it in action
3. Read [ARCHITECTURE.md](ARCHITECTURE.md) - Understand the design
4. Read [PLUGIN_GUIDE.md](PLUGIN_GUIDE.md) - Learn to extend
...
- `acs_engine.py` - Original monolithic engine (1025 lines)
...
### Project Status
- [REFACTORING_SUMMARY.md](REFACTORING_SUMMARY.md) - What's done
  - Accomplishments
...
**Q: Can I use the old `acs_engine.py`?**
